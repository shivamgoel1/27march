...
public class Doctor {
	...
	public Doctor(String firstname, String lastname, int age, String gender, String dob, String contactnumber,
			String atlcontactnumber, String email, String password, String addressline1, String addressline2,
			String city, String state, String zipcode, String degree, String specialty, String work_hours,
			String hospital, int medical_service_id) {
		super();
	...
	public Doctor(int id, String firstname, String lastname, int age, String gender, String dob, String contactnumber,
			String atlcontactnumber, String email, String password, String addressline1, String addressline2,
	...
	public String toString() {
		return "Doctor [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", age=" + age + ", gender="
				...
				+ hospital + ", medical_service_id=" + medical_service_id + "]";
	}
